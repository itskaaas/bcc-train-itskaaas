...
Config.LockPick = {
    ...
    difficulty = 0.5,       -- +- threshold to the stage degree (bigger number means easier)
    hintdelay = 500,        -- milliseconds delay on when the circle will shake to show lockpick is in the right position.
    pins = 3,               -- Number of pins to pick
    randomPins = true       -- If true, pins will be random degrees; if false, use static degrees
}
-----------------------------------------------------
